...
export default function Home() {
  return (
    <main className="relative min-h-screen text-white">
      {/* Top Bar */}
      <header className="sticky top-0 z-50 backdrop-blur bg-navy-deep/80 border-b border-white/10">
        <nav className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <a href="/" className="flex items-center gap-3 group">
            <div className="w-9 h-9 rounded-md bg-gradient-to-br from-amber to-amber-deep flex items-center justify-center shadow-lg">
              <span className="text-navy-deep font-black text-sm tracking-wider">E</span>
            </div>
            <div className="flex flex-col">
              <span className="font-bold tracking-tight leading-none">EADIE</span>
              <span className="text-[10px] text-white/60 leading-none mt-0.5 uppercase tracking-widest">An Encore Product</span>
            </div>
          </a>
          <div className="hidden md:flex items-center gap-7 text-sm">
            <a href="#platform" className="text-white/70 hover:text-amber-bright transition-colors">Platform</a>
            <a href="#dimensions" className="text-white/70 hover:text-amber-bright transition-colors">Dimensions</a>
            <a href="#workflow" className="text-white/70 hover:text-amber-bright transition-colors">Workflow</a>
            <a href="#audit" className="text-white/70 hover:text-amber-bright transition-colors">Audit Trail</a>
            <a href="#contact" className="px-4 py-1.5 rounded border border-amber/40 text-amber-bright hover:bg-amber/10 transition-colors">Request Briefing</a>
          </div>
        </nav>
      </header>
      ...
      <section className="relative overflow-hidden grid-bg">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-navy/30 to-transparent"></div>
        <div className="relative max-w-5xl mx-auto px-6 pt-24 pb-20 md:pt-32 md:pb-28 text-center">
          <span className="inline-block px-3 py-1 rounded-full text-xs font-medium tracking-wider uppercase border border-amber/40 text-amber-bright bg-amber/5 mb-8">
            An Encore Services product · Production-grade AI for federal missions
          </span>
          ...
          <p className="text-lg md:text-xl text-white/85 max-w-3xl mx-auto leading-relaxed mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a href="#contact" className="px-7 py-3 rounded-lg bg-gradient-to-r from-amber to-amber-deep text-navy-deep font-bold hover:opacity-90 transition-opacity shadow-lg">
              Request a federal briefing
            </a>
            <a href="#workflow" className="text-sm text-white/70 hover:text-amber-bright transition-colors">
              See how the workflow works →
            </a>
          </div>
          <hr className="divider-flag-subtle max-w-md mx-auto mt-12" />
        </div>
      </section>

      {/* Credibility strip */}
      <section className="border-y border-amber/20 bg-navy/40 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto px-6 py-10 md:py-12">
          <div className="grid md:grid-cols-3 gap-8 md:gap-12 text-center">
            <div>
              <div className="text-3xl md:text-4xl font-bold text-amber-bright mb-2">Weeks → Hours</div>
              <div className="text-sm text-white/70">Senior-CO depth at a CO-team pace</div>
            </div>
            <div className="md:border-x md:border-white/10">
              <div className="text-3xl md:text-4xl font-bold text-amber-bright mb-2">10 Dimensions</div>
              <div className="text-sm text-white/70">Beyond the standard four-axis match</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-amber-bright mb-2">Protest-Defensible</div>
              <div className="text-sm text-white/70">Auditable reasoning chain on every decision</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="platform" className="py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-6">
          <span className="inline-block px-3 py-1 rounded-full text-xs font-medium tracking-wider uppercase border border-amber/40 text-amber-bright bg-amber/5 mb-6">The Problem</span>
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6">
            The standard four-axis match is missing most of how senior COs actually think.
          </h2>
          <p className="text-lg text-white/85 leading-relaxed mb-6 max-w-4xl">
          ...
          <p className="text-base text-white/65 leading-relaxed max-w-4xl">
      ...
      {/* Ten Dimensions */}
      <section id="dimensions" className="py-20 md:py-28 bg-navy/40 backdrop-blur-sm border-y border-white/10">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            <span className="inline-block px-3 py-1 rounded-full text-xs font-medium tracking-wider uppercase border border-amber/40 text-amber-bright bg-amber/5 mb-6">The Ten Dimensions</span>
      ...
      <section id="workflow" className="py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-6">
          <span className="inline-block px-3 py-1 rounded-full text-xs font-medium tracking-wider uppercase border border-amber/40 text-amber-bright bg-amber/5 mb-6">The Workflow</span>
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6">
            Pause anywhere. Ask anything. Resume with refinements applied.
          </h2>
          <p className="text-lg text-white/85 leading-relaxed mb-12 max-w-4xl">
          ...
          <div className="rounded-2xl border border-amber/30 bg-navy/60 backdrop-blur-sm p-8 md:p-10 shadow-2xl">
            <h3 className="text-xl md:text-2xl font-bold text-amber-bright mb-4">Workspace forking and collaboration, built in</h3>
      ...
      {/* Audit Trail */}
      <section id="audit" className="py-20 md:py-28 bg-navy/40 backdrop-blur-sm border-y border-white/10">
        <div className="max-w-5xl mx-auto px-6">
          <span className="inline-block px-3 py-1 rounded-full text-xs font-medium tracking-wider uppercase border border-amber/40 text-amber-bright bg-amber/5 mb-6">Protest Defense</span>
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6">
            An auditable reasoning chain on every decision.
          </h2>
          <p className="text-lg text-white/85 leading-relaxed mb-10 max-w-4xl">
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-6">
          <span className="inline-block px-3 py-1 rounded-full text-xs font-medium tracking-wider uppercase border border-amber/40 text-amber-bright bg-amber/5 mb-6">An Encore Services Product</span>
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6">
          ...
          <p className="text-base text-white/65 leading-relaxed mb-10 max-w-4xl">
            EADIE extends Encore's federal procurement product portfolio alongside the Encore Contract Writing Suite (ECWS), AcuSightPro, and additional AI-driven mission systems.
          </p>
          <div className="grid md:grid-cols-2 gap-6">
            <FeatureBlock
            ...
            <FeatureBlock
              ...
              body="Available as a stand-alone application and as a gated add-on to existing federal procurement platforms. Per-user, team, or office-wide entitlement."
            />
            <FeatureBlock
              title="Compound learning across acquisitions"
              body="Methodologies improve over time based on observed outcomes. Anonymized workspace data tightens dimension scoring and refines default methodology profiles."
            />
            <FeatureBlock
      ...
      <section className="py-16 bg-navy/40 backdrop-blur-sm border-y border-white/10">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h3 className="text-xs uppercase tracking-[0.2em] text-amber-bright mb-6">Encore Services Business Designations</h3>
          <div className="flex flex-wrap justify-center gap-4">
            <DesignationBadge label="Service-Disabled Veteran-Owned Small Business (SDVOSB)" />
            <DesignationBadge label="Veteran-Owned Small Business (VOSB)" />
            <DesignationBadge label="Small Disadvantaged Business (SDB)" />
          </div>
        </div>
      </section>

      {/* Contact + Dr. Jeff Woodson Card */}
      <section id="contact" className="py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-14">
            <span className="inline-block px-3 py-1 rounded-full text-xs font-medium tracking-wider uppercase border border-amber/40 text-amber-bright bg-amber/5 mb-6">Contact</span>
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">
              Available for federal briefings and pilots.
            </h2>
            <p className="text-white/85 max-w-2xl mx-auto">
              We are actively engaging contracting offices, agency procurement leadership, and federal acquisition modernization teams. Reach out directly to schedule a briefing or pilot conversation.
            </p>
          </div>

          {/* Dr. Jeff Woodson contact card — mirrors Encore site exactly */}
          <Reveal>
            <div className="rounded-2xl border border-amber/30 bg-navy/70 backdrop-blur-md p-8 md:p-10 shadow-2xl max-w-xl mx-auto">
              <div className="text-[10px] uppercase tracking-[0.2em] text-amber-bright mb-3">Principal Contact</div>
              <h3 className="text-2xl md:text-3xl font-bold tracking-tight mb-1">Dr. Jeff Woodson</h3>
              <div className="text-sm uppercase tracking-widest mb-6 text-amber-bright">
                President &amp; CEO · Encore Services, LLC
              </div>

              <div className="space-y-5 text-sm">
                <div>
                  <div className="text-[10px] uppercase tracking-[0.2em] text-white/60 mb-1">Address</div>
                ...
                <div>
                  <div className="text-[10px] uppercase tracking-[0.2em] text-white/60 mb-1">Business</div>
                  <a
                    href="tel:+12024608668"
                    className="text-white hover:text-amber-bright transition-colors text-sm font-semibold"
                  >
                    (202) 460-8668
                  </a>
                </div>
                ...
                <div>
                  <div className="text-[10px] uppercase tracking-[0.2em] text-white/60 mb-1">Mobile</div>
                  <a
                    href="tel:+13016753001"
                    className="text-white hover:text-amber-bright transition-colors text-sm font-semibold"
                  >
                    (301) 675-3001
                  </a>
                ...
                <div>
                  <div className="text-[10px] uppercase tracking-[0.2em] text-white/60 mb-1">Email</div>
                  <a
                    href="mailto:jwoodson@encoresvcsllc.com"
                    className="text-white hover:text-amber-bright transition-colors break-all text-sm"
                  >
                ...
                <div>
                  <div className="text-[10px] uppercase tracking-[0.2em] text-white/60 mb-1">Parent Company</div>
                  <a
                    href="https://encoresvcsllc.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-white hover:text-amber-bright transition-colors text-sm"
                  >
                    encoresvcsllc.com →
                  </a>
                </div>
              ...
              <hr className="divider-flag mt-8" />
      ...
      <footer className="border-t border-white/10 bg-navy-deep/60">
        <div className="max-w-6xl mx-auto px-6 py-10 text-center">
          <div className="text-sm text-white/70 mb-2">
            EADIE — Encore Acquisition Decision Intelligence Engine, a product of <a href="https://encoresvcsllc.com" className="text-amber-bright hover:underline" target="_blank" rel="noopener noreferrer">Encore Services, LLC</a>.
          </div>
          <div className="text-xs text-white/50">
            © {new Date().getFullYear()} Encore Services, LLC. All rights reserved. U.S. Provisional Patent Application Filed.
          </div>
          <div className="text-xs text-white/60 mt-4 flex items-center justify-center gap-4">
            <a href="/terms" className="hover:text-amber-bright transition-colors">Terms of Service</a>
            <span>·</span>
            <a href="/privacy" className="hover:text-amber-bright transition-colors">Privacy Policy</a>
            <span>·</span>
            <a href="/disclosures" className="hover:text-amber-bright transition-colors">Disclosures</a>
          </div>
        </div>
      </footer>
    </main>
...
function DimensionCard({ num, title, body }: { num: string; title: string; body: string }) {
  return (
    <article className="h-full rounded-2xl border border-white/10 bg-navy/40 backdrop-blur-sm p-7 hover:bg-navy/60 hover:border-amber/40 hover:-translate-y-1 transition-all duration-300 shadow-xl">
      <div className="text-xs font-bold tracking-widest text-amber-bright mb-3">DIMENSION {num}</div>
...
function WorkflowStep({ num, title, body }: { num: string; title: string; body: string }) {
  return (
    <article className="h-full rounded-2xl border border-amber/30 bg-navy/50 backdrop-blur-sm p-7 hover:border-amber/60 hover:-translate-y-1 transition-all duration-300 shadow-xl">
      <div className="text-3xl font-bold text-amber-bright mb-3">{num}</div>
...
function AuditItem({ title, body }: { title: string; body: string }) {
  return (
    <article className="rounded-xl border border-white/10 bg-navy/40 backdrop-blur-sm p-6">
      <h3 className="text-base font-bold text-amber-bright mb-2">{title}</h3>
      <p className="text-sm text-white/85 leading-relaxed">{body}</p>
    </article>
  );
}
...
function FeatureBlock({ title, body }: { title: string; body: string }) {
  return (
    <article className="rounded-2xl border border-white/10 bg-navy/40 backdrop-blur-sm p-7">
      <h3 className="text-lg font-bold text-amber-bright mb-3">{title}</h3>
      <p className="text-sm text-white/85 leading-relaxed">{body}</p>
    </article>
  );
}

function DesignationBadge({ label }: { label: string }) {
  return (
    <div className="px-4 py-2 rounded-lg border border-amber/30 bg-amber/5 text-amber-bright text-xs uppercase tracking-wider font-semibold">
      {label}
    </div>
  );
}
